      ...
      <div class="col-lg-12">
        <div class="content_bottom_left">
          <div class="single_category wow fadeInDown">
            <h2> <span class="bold_line"><span></span></span> <span class="solid_line"></span> <a class="title_text" href="#"><div class="glyphicon glyphicon-book"></div> COmmande CLIENT</a> </h2>
				  <fieldset>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="content_middle_leftbar">
              <div class="single_category wow fadeInDown">
                ...
                <?php require_once'../Commandecli/readAllComCli.php'; ?>
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="content_middle_rightbar">
              <div class="single_category wow fadeInDown">
                ...
                <?php require_once'readAllLComClin.php'; ?>      
              </div>
            </div>
          </div>
			  </fieldset>
